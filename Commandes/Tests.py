...
if __name__ == "__main__":
    ...
    if Regeneration:
        ...
        commandeAPI.mapinfactory(factoryId, "..\\Visualisation\\Madrillet.png", (-21.0, -33.2, 0.0), 0.05)
        ...
        ope2 = json["_id"]
        json = commandeAPI.createOperationHuman(factoryId, Mhammed, ["Regarder Michel travailler","Analyser le temps qui passe","rediger le rapport d'activité"], (3.1, 2.5, 35/180*3.1415927),previous=ope1)
        ope3 = json["_id"]
        ...
        machineId = json["_id"]
        commandeAPI.moveMachine(factoryId,machineId,{"position":{"x": 1.0 , "y": 5.1, "z": 0.0},"rotation":{"qx": 0.0, "qy": 0.0, "qz": 0.0, "qw":  1.0}})
