...
nomfactory = "TURTLEBOTS ARENA"
nomrobot = "waffle_03"
#robotId = "617c0edbfbfcba10fef78094"
...
if __name__ == "__main__":
    ...
    try: # fonctionne sur le robot ou pas ?
        ...
        robotreel = waffle.Waffle(nom=nomrobot, lienhttp="")
    except ImportError:
        robotreel = waffle.Waffle(nom=nomrobot, lienhttp='http://waffle_arm.rorecherche/ajax/')
