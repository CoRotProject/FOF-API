...
positions={ "Coul1":[2.57, 4.35, 64.5],
            "Coul2":[-2.33, 6.17, 172.0],
            "Centre":[2.53, -2.13, 80.0],
}
...
class CERI_AGV:
    def __init__(self, nom):
        ...
        self.pose_sub = rospy.Subscriber('/amcl_pose', PoseWithCovarianceStamped, self.pose_listener)
