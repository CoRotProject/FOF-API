...
try:
    # mode developpement
    # factoryid = findfactory(name="Factory LINEACT Test Fabrice")[0]
    # mode reel
    if commandeAPI.check_ping("10.191.76.25"):
        # factoryid = commandeAPI.findfactory(name="Factory R1 test")[0]
        factoryid = commandeAPI.findfactory(name="Factory Said")[0]
    else:
        factoryid = commandeAPI.findfactory(name="Factory LINEACT Virtual")[0]
...
# # En cas de debuggage à la maison
# commandeAPI.urlTemplate = "http://192.168.1.21:5000/"
# commandeAPI.urlTemplateFactory = commandeAPI.urlTemplate+'factory/{factoryid}/'
